...
<html lang="en">
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      <img src="<?= baseurl;?>/asset/img/SilviS.jpg" alt="" width="250" height="250" class="rounded-circle img-thumbnail"./>
      <h1 class="display-4">Silvi Sopawiah</h1>
    ...
    <section id="About">
      ...
      <div class="row justify-content-center ">
          <div class="col-md-4 mb-3">
            <p>“Suksesmu tidak diukur dari seberapa banyak uangmu, namun seberapa banyak kamu meringankan beban orang lain.”</p></p>
          </div>
          <div class="col-md-4 mb-3">
            <p>“Impianmu akan menjadi kenyataan, hanya jika kamu memiliki keberanian untuk mewujudkannya"</p>
          </div>
      </div>
...
<section id="project">
  <div class="Container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-4 mb-3">
        <div class="card">
          <img src="<?= baseurl;?>/asset/img/img1.jpg" class="card-img-top" alt="Project 1">
          <div class="card-body">
            <h3>Judul</h3>
